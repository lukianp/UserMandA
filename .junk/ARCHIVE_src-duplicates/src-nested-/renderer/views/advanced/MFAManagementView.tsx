...
export const MFAManagementView: React.FC = () => {
  return (
    <div className="flex flex-col h-full p-6 space-y-6" data-testid="m-f-a-management-view" data-cy="m-f-a-management-view">
      <div>
        <h1 className="text-2xl font-bold">MFA Management</h1>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          Manage MFA Management settings and policies
        </p>
      </div>
...
export default MFAManagementView;
