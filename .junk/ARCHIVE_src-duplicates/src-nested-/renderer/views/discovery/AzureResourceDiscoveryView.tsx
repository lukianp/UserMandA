...
import { useAzureResourceDiscovery } from "../../hooks/useAzureResourceDiscovery";
...
export default function AzureResourceDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="azure-resource-discovery-view" data-cy="azure-resource-discovery-view">
      <h1 className="text-xl font-semibold">AzureResource Discovery</h1>
