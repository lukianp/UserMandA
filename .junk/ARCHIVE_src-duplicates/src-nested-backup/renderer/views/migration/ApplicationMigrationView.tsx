...
import { useApplicationMigration } from "../../hooks/useApplicationMigration";
...
export default function ApplicationMigrationView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="application-migration-view" data-cy="application-migration-view">
      <h1 className="text-xl font-semibold">Application Migration</h1>
