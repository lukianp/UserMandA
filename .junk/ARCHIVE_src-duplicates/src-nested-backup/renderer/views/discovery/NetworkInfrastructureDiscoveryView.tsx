...
import { useNetworkInfrastructureDiscovery } from "../../hooks/useNetworkInfrastructureDiscovery";
...
export default function NetworkInfrastructureDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="network-infrastructure-discovery-view" data-cy="network-infrastructure-discovery-view">
      <h1 className="text-xl font-semibold">NetworkInfrastructure Discovery</h1>
