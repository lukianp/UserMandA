...
import { useBackupRecoveryDiscovery } from "../../hooks/useBackupRecoveryDiscovery";
...
export default function BackupRecoveryDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="backup-recovery-discovery-view" data-cy="backup-recovery-discovery-view">
      <h1 className="text-xl font-semibold">BackupRecovery Discovery</h1>
