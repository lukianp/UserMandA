...
import { useAWSDiscovery } from "../../hooks/useAWSDiscovery";
...
export default function AWSDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="a-w-s-discovery-view" data-cy="a-w-s-discovery-view">
      <h1 className="text-xl font-semibold">AWS Discovery</h1>
