...
import { useGraphDiscovery } from "../../hooks/useGraphDiscovery";
...
export default function GraphDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="graph-discovery-view" data-cy="graph-discovery-view">
      <h1 className="text-xl font-semibold">Graph Discovery</h1>
