...
import { usePaloAltoDiscovery } from "../../hooks/usePaloAltoDiscovery";
...
export default function PaloAltoDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="palo-alto-discovery-view" data-cy="palo-alto-discovery-view">
      <h1 className="text-xl font-semibold">PaloAlto Discovery</h1>
