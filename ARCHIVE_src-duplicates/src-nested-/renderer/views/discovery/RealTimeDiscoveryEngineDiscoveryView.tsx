...
import { useRealTimeDiscoveryEngineDiscovery } from "../../hooks/useRealTimeDiscoveryEngineDiscovery";
...
export default function RealTimeDiscoveryEngineDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="real-time-discovery-engine-discovery-view" data-cy="real-time-discovery-engine-discovery-view">
      <h1 className="text-xl font-semibold">RealTimeDiscoveryEngine Discovery</h1>
