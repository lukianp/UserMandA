...
export const CapacityPlanningView: React.FC = () => {
  return (
    <div className="flex flex-col h-full p-6 space-y-6" data-testid="capacity-planning-view" data-cy="capacity-planning-view">
      <div>
        <h1 className="text-2xl font-bold">Capacity Planning</h1>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          Advanced Capacity Planning capabilities for enterprise management
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border flex-1">
        <h3 className="font-semibold mb-4">Capacity Planning Dashboard</h3>
        <p className="text-gray-600 dark:text-gray-400">
          Comprehensive Capacity Planning features and analytics will be displayed here.
        </p>
      </div>
    </div>
  );
