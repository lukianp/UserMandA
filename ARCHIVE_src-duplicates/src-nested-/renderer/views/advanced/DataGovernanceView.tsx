...
export const DataGovernanceView: React.FC = () => {
  return (
    <div className="flex flex-col h-full p-6 space-y-6" data-testid="data-governance-view" data-cy="data-governance-view">
      <div>
        <h1 className="text-2xl font-bold">Data Governance</h1>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          Manage Data Governance settings and policies
        </p>
      </div>
