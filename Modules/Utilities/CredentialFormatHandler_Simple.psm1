<#
.SYNOPSIS
    Simplified credential file format operations for M&A Discovery Suite
.DESCRIPTION
    Provides functions to read and save encrypted credential files without complex ACL operations
#>
...
function Read-CredentialFile {
    ...
    try {
        $encryptedData = Get-Content $Path -Raw -Encoding UTF8
...
function Save-CredentialFile {
    ...
    try {
        ...
        # Save to file (without complex ACL operations)
