...
function Calculate-SystemMetricsDelta {
    <#
    .SYNOPSIS
        Calculates the difference between initial and final system metrics.
    .DESCRIPTION
        Computes the delta values for system performance metrics.
    .PARAMETER Initial
        The initial system metrics.
    .PARAMETER Final
        The final system metrics.
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory=$true)]
...
function Start-PerformanceSession {
    <#
    .SYNOPSIS
        Starts a named performance measurement session.
    .DESCRIPTION
        Begins tracking performance for a named session that can span multiple operations.
    .PARAMETER SessionName
        The name of the performance session.
    .PARAMETER Context
        The context object for logging.
    .EXAMPLE
        Start-PerformanceSession -SessionName "FullDiscovery" -Context $context
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory=$true)]
...
function Stop-PerformanceSession {
    <#
    .SYNOPSIS
        Stops a named performance measurement session.
    .DESCRIPTION
        Ends tracking for a named session and returns the session summary.
    .PARAMETER SessionName
        The name of the performance session to stop.
    .PARAMETER Context
        The context object for logging.
    .EXAMPLE
...
function Get-PerformanceReport {
    ...
    .DESCRIPTION
        Creates a comprehensive performance report with statistics and analysis.
    .PARAMETER OperationFilter
        Filter to specific operations (supports wildcards).
    .PARAMETER CategoryFilter
        Filter to specific categories.
    .PARAMETER TimeRange
        Time range for the report (in hours from now).
    .PARAMETER IncludeSystemMetrics
        Whether to include system metrics in the report.
    .EXAMPLE
...
function Clear-PerformanceData {
    ...
    .DESCRIPTION
        Removes all performance metrics from memory to free up resources.
    .PARAMETER Context
        The context object for logging.
    .EXAMPLE
        Clear-PerformanceData -Context $context
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory=$false)]
...
function Get-PerformanceStatistics {
    <#
    .SYNOPSIS
        Gets current performance tracking statistics.
    .DESCRIPTION
        Returns summary statistics about the current performance data collection.
    .EXAMPLE
