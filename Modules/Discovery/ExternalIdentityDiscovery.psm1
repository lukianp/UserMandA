        ...
        try {
            ...
            if ($crossTenantPolicy) {
                ...
                $accessData.Add([PSCustomObject]@{
                    ...
                    InboundTrust_MfaEnabled = $defaultSettings.b2bCollaborationInbound.usersAndGroups.accessType
                    InboundTrust_CompliantDeviceEnabled = $defaultSettings.b2bCollaborationInbound.applications.accessType
