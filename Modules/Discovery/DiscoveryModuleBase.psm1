...
function Invoke-DiscoveryModuleBaseDiscovery {
    param([hashtable]$Configuration, $Context)
    
    try {
        $result = [DiscoveryResult]::new('DiscoveryModuleBase')
        ...
        $result = [DiscoveryResult]::new('DiscoveryModuleBase')
        $result.AddError("Error: $(# -*- coding: utf-8-bom -*-
#Requires -Version 5.1
...
.Exception.Message)", # -*- coding: utf-8-bom -*-
#Requires -Version 5.1
