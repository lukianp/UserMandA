...
function Get-SoftwareLicenseInventory {
    ...
    foreach ($computerName in $ComputerNames) {
        try {
            Write-Verbose "[ApplicationDiscovery] Scanning software on $computerName..." -Verbose
...
function Export-SoftwareLicenseReport {
    ...
    try {
        ...
        Write-Information "[ApplicationDiscovery] Software license reports exported to: $OutputPath" -InformationAction Continue
