# Authentication Module Syntax Validation Script
Write-Host "=== Authentication Module Syntax Validation ===" -ForegroundColor Cyan

$authPath = "Modules/Authentication"
$modules = Get-ChildItem "$authPath/*.psm1"
