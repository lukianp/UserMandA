...
namespace MandADiscoverySuite.Services
{
    ...
    public class IntelligentCacheService : IDisposable
    {
        ...
        private readonly ConcurrentDictionary<string, InternalCacheStatistics> _statistics;
        ...
        public IntelligentCacheService()
        {
            ...
            _statistics = new ConcurrentDictionary<string, InternalCacheStatistics>();
        ...
        private void UpdateStatistics(string key, bool hit)
        {
            _statistics.AddOrUpdate(key, 
                new InternalCacheStatistics { Hits = hit ? 1 : 0, Misses = hit ? 0 : 1 },
                (k, existing) => 
                {
        ...
        private class InternalCacheStatistics
        {
