...
namespace MandADiscoverySuite.Services
{
    ...
    public class EnhancedLoggingService : IDisposable
    {
        ...
        private EnhancedLoggingService()
        {
            ...
            var mainLogDirectory = Path.Combine(ConfigurationService.Instance.DiscoveryDataRootPath, "ljpops", "Logs");
        ...
        public async Task LogGuiDebugAsync(string message, [CallerMemberName] string memberName = "", [CallerFilePath] string filePath = "", [CallerLineNumber] int lineNumber = 0)
        {
            try
            {
                ...
                var guiDebugPath = Path.Combine(ConfigurationService.Instance.DiscoveryDataRootPath, "ljpops", "Logs", "gui-debug.log");
