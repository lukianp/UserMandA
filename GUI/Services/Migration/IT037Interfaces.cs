...
namespace MandADiscoverySuite.Services.Migration
{
    ...
    public interface IAclMigrator : IMigrationProvider<AclMigrationItem, AclMigrationResult>
    {
        ...
        /// </summary>
        Task<AclMigrationResult> RecreateAclsAsync(string targetPath, List<Models.Migration.AclEntry> sourceAcls, Dictionary<string, string> sidMapping, MigrationContext context, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<AclValidationResult> ValidateAclCompatibilityAsync(List<Models.Migration.AclEntry> acls, string targetFileSystem, MigrationContext context, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<BulkAclMigrationResult> BulkApplyAclsAsync(Dictionary<string, List<Models.Migration.AclEntry>> pathAclMap, Dictionary<string, string> sidMapping, MigrationContext context, CancellationToken cancellationToken = default);
