...
namespace MandADiscoverySuite.ViewModels
{
    ...
    /// </summary>
    public class FileServersViewModelNew : BaseViewModel
    {
        ...
        public FileServersViewModelNew(
            CsvDataServiceNew csvService, 
            ILogger<FileServersViewModelNew> logger, 
        ...
        public override async Task LoadAsync()
        {
            ...
            try 
            {
                ...
                Logger?.LogInformation($"[{GetType().Name}] Load ok rows={FileServers.Count}");
            }
            catch (Exception ex) 
            {
