...
namespace MandADiscoverySuite.ViewModels
{
    ...
    /// </summary>
    public class DatabasesViewModelNew : BaseViewModel
    {
        ...
        public DatabasesViewModelNew(
            CsvDataServiceNew csvService, 
            ILogger<DatabasesViewModelNew> logger, 
        ...
        public override async Task LoadAsync()
        {
            ...
            try 
            {
                ...
                Logger?.LogInformation($"[{GetType().Name}] Load ok rows={Databases.Count}");
            }
            catch (Exception ex) 
            {
