...
namespace MandADiscoverySuite.ViewModels
{
    ...
    public class DataExportManagerViewModel : BaseViewModel
    {
        ...
        public DataExportManagerViewModel(
            ...
            CsvDataServiceNew csvDataService = null) : base()
        {
            // Services are optional - we'll use SimpleServiceLocator if not provided
            _notesTaggingService = notesTaggingService ?? SimpleServiceLocator.Instance.GetService<INotesTaggingService>();
            _riskAnalysisService = riskAnalysisService ?? SimpleServiceLocator.Instance.GetService<IRiskAnalysisService>();
            _whatIfService = whatIfService ?? SimpleServiceLocator.Instance.GetService<IWhatIfSimulationService>();
            _reportBuilderService = reportBuilderService ?? SimpleServiceLocator.Instance.GetService<IReportBuilderService>();
            _csvDataService = csvDataService ?? SimpleServiceLocator.Instance.GetService<CsvDataServiceNew>();
