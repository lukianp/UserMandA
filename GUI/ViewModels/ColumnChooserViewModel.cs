...
namespace MandADiscoverySuite.ViewModels
{
    ...
    public class ColumnChooserViewModel : BaseViewModel
    {
        ...
        private void ShowColumn()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ColumnChooserViewModel.ShowColumn failed: {ex.Message}");
            }
        }
        ...
        private void HideColumn()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ColumnChooserViewModel.HideColumn failed: {ex.Message}");
            }
        }
        ...
        private void UpdateConfiguration()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"ColumnChooserViewModel.UpdateConfiguration failed: {ex.Message}");
            }
        }
