...
namespace MandADiscoverySuite.ViewModels
{
    ...
    public class StatusIndicatorViewModel : BaseViewModel
    {
        ...
        public void UpdateStatus(StatusType status, string text = null, double? progress = null, string tooltip = null)
        {
            ...
            {
                Logger?.LogError(ex, "StatusIndicatorViewModel.UpdateStatus failed: {Message}", ex.Message);
                System.Diagnostics.Debug.WriteLine($"StatusIndicatorViewModel.UpdateStatus failed: {ex.Message}");
            }
        }
