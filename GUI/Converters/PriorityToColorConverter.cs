    ...
    public class PriorityToColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is TaskPriority priority)
            {
                ...
                {
                    TaskPriority.High => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#EF4444")), // Red
                    TaskPriority.Medium => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#F59E0B")), // Yellow
                    TaskPriority.Low => new SolidColorBrush((Color)ColorConverter.ConvertFromString("#10B981")), // Green
