/**
 * Consolidated Applications View
 *
 * Displays consolidated application entities from all discovery sources
 */
...
export const ConsolidatedApplicationsView: React.FC = () => {
  ...
  const handleEntityClick = (entity: InventoryEntity) => {
    ...
    console.log('[ConsolidatedApplicationsView] Entity clicked:', entity);
  };
