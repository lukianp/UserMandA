...
const AssetInventoryView: React.FC = () => {
  ...
  return (
    <div className="min-h-full flex flex-col p-6" data-testid="asset-inventory-view" data-cy="asset-inventory-view">
      {/* Header */}
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border border-gray-200 dark:border-gray-700">
            <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">
              {(typeof statistics?.avgAge === 'number' ? statistics.avgAge : 0).toFixed(1)} yrs
            </div>
