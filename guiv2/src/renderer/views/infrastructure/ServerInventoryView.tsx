/**
 * Server Inventory View Component
 * Displays physical and virtual server inventory with detailed metrics
 */
...
const ServerInventoryView: React.FC = () => {
  ...
  return (
    <div className="min-h-full flex flex-col bg-gray-50 dark:bg-gray-900" data-testid="server-inventory-view" data-cy="server-inventory-view">
      {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Physical and virtual server infrastructure management
              </p>
            </div>
          </div>
