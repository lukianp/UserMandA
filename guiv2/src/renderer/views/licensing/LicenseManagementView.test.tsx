...
// Mock the hook
jest.mock('../../hooks/useLicenseManagementLogic', () => ({
  useLicenseManagementLogic: jest.fn(),
}));
...
describe('LicenseManagementView', () => {
  ...
  beforeEach(() => {
    resetAllMocks();
    useLicenseManagementLogic.mockReturnValue(mockHookDefaults);
  });
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      ...
      expect(screen.getByTestId('license-management-view')).toBeInTheDocument();
    });
    ...
    it('displays the view description', () => {
      render(<LicenseManagementView />);
      expect(
        screen.getByText(/Manage licenses/i)
      ).toBeInTheDocument();
    });

    it('displays the icon', () => {
      const { container } = render(<LicenseManagementView />);
  ...
  describe('Integration', () => {
    it('handles complete workflow', async () => {
      ...
      rerender(<LicenseManagementView />);
      expect(screen.queryByRole('status')).not.toBeInTheDocument();
