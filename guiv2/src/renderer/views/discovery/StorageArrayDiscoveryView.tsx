...
import { useStorageArrayDiscovery } from "../../hooks/useStorageArrayDiscovery";
...
export default function StorageArrayDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="storage-array-discovery-view" data-cy="storage-array-discovery-view">
      <h1 className="text-xl font-semibold">StorageArray Discovery</h1>
