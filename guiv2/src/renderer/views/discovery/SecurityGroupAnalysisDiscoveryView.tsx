...
import { useSecurityGroupAnalysisDiscovery } from "../../hooks/useSecurityGroupAnalysisDiscovery";
...
export default function SecurityGroupAnalysisDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="security-group-analysis-discovery-view" data-cy="security-group-analysis-discovery-view">
      <h1 className="text-xl font-semibold">SecurityGroupAnalysis Discovery</h1>
