...
import { useWebServerConfigDiscovery } from "../../hooks/useWebServerConfigDiscovery";
...
export default function WebServerConfigDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="web-server-config-discovery-view" data-cy="web-server-config-discovery-view">
      <h1 className="text-xl font-semibold">WebServerConfig Discovery</h1>
