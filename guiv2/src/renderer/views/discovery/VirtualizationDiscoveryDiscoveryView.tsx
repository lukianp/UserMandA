...
import { useVirtualizationDiscoveryDiscovery } from "../../hooks/useVirtualizationDiscoveryDiscovery";
...
export default function VirtualizationDiscoveryDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="virtualization-discovery-discovery-view" data-cy="virtualization-discovery-discovery-view">
      <h1 className="text-xl font-semibold">VirtualizationDiscovery Discovery</h1>
