...
export default function DNSDHCPDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="d-n-s-d-h-c-p-discovery-view" data-cy="d-n-s-d-h-c-p-discovery-view">
      <h1 className="text-xl font-semibold">DNSDHCP Discovery</h1>
