...
import { useConcurrentDiscoveryEngineDiscovery } from "../../hooks/useConcurrentDiscoveryEngineDiscovery";
...
export default function ConcurrentDiscoveryEngineDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="concurrent-discovery-engine-discovery-view" data-cy="concurrent-discovery-engine-discovery-view">
      <h1 className="text-xl font-semibold">ConcurrentDiscoveryEngine Discovery</h1>
