...
export default function PowerBIDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="power-b-i-discovery-view" data-cy="power-b-i-discovery-view">
      <h1 className="text-xl font-semibold">PowerBI Discovery</h1>
