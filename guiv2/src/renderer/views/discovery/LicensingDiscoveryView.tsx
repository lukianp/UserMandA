        ...
        <div className="grid grid-cols-4 gap-4 p-6">
          ...
          <div className="p-4 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow text-white">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold">{stats.utilizationRate.toFixed(1)}%</div>
          ...
          <div className="p-4 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg shadow text-white">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold">${stats.costPerMonth.toLocaleString(undefined, { maximumFractionDigits: 0 })}</div>
      ...
      <div className="flex-1 flex flex-col p-6 overflow-hidden">
          ...
          <div className="space-y-6 overflow-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                {stats.topCostProducts.map((item, index) => (
        ...
        {activeTab === 'compliance' && result?.complianceStatus && (
          <div className="space-y-6 overflow-auto">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {result.complianceStatus.isCompliant ? 'Compliant' : 'Non-Compliant'}
                </h3>
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Overall Utilization: {result.complianceStatus.utilizationRate.toFixed(1)}%
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Unassigned Licenses: {result.complianceStatus.unassignedLicenses.toLocaleString()}
              </div>
            </div>

            {result.complianceStatus.underlicensedProducts.length > 0 && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg shadow p-6">
                ...
                <ul className="space-y-2">
                  {result.complianceStatus.underlicensedProducts.map((product, index) => (
            ...
            {result.complianceStatus.overlicensedProducts.length > 0 && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg shadow p-6">
                ...
                <ul className="space-y-2">
                  {result.complianceStatus.overlicensedProducts.map((product, index) => (
            ...
            {result.complianceStatus.expiringSoon.length > 0 && (
              <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg shadow p-6">
                ...
                <div className="space-y-2">
                  {result.complianceStatus.expiringSoon.map((license, index) => (
