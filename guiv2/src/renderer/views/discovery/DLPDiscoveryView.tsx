...
import { useDLPDiscovery } from "../../hooks/useDLPDiscovery";
...
export default function DLPDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="d-l-p-discovery-view" data-cy="d-l-p-discovery-view">
      <h1 className="text-xl font-semibold">DLP Discovery</h1>
