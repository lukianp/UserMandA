...
import { useExternalIdentityDiscoveryDiscovery } from "../../hooks/useExternalIdentityDiscoveryDiscovery";
...
export default function ExternalIdentityDiscoveryDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="external-identity-discovery-discovery-view" data-cy="external-identity-discovery-discovery-view">
      <h1 className="text-xl font-semibold">ExternalIdentityDiscovery Discovery</h1>
