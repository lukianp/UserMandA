...
import { useMultiDomainForestDiscoveryDiscovery } from "../../hooks/useMultiDomainForestDiscoveryDiscovery";
...
export default function MultiDomainForestDiscoveryDiscoveryView(){
  ...
  return (
    <div className="p-4 space-y-3" data-testid="multi-domain-forest-discovery-discovery-view" data-cy="multi-domain-forest-discovery-discovery-view">
      <h1 className="text-xl font-semibold">MultiDomainForestDiscovery Discovery</h1>
