...
export const discoveryNavItems = [
  ...
  // =========================================================================
  { path: '/discovery/azure-automation', label: 'Automation Accounts', icon: <Settings size={16} /> },
  { path: '/discovery/azure-acr', label: 'Container Registry', icon: <Package size={16} /> },
  ...
  { path: '/discovery/azure-keyvault-access', label: 'Key Vault Access', icon: <Key size={16} /> },
  { path: '/discovery/azure-logicapps', label: 'Logic Apps', icon: <Workflow size={16} /> },
  { path: '/discovery/azure-managed-identities', label: 'Managed Identities', icon: <Fingerprint size={16} /> },
  { path: '/discovery/azure-mgmt-groups', label: 'Management Groups', icon: <FolderTree size={16} /> },
  { path: '/discovery/azure-sp-credentials', label: 'Service Principal Credentials', icon: <KeyRound size={16} /> },
  { path: '/discovery/azure-storage-access', label: 'Storage Account Access', icon: <Database size={16} /> },
  ...
  { path: '/discovery/azure', label: 'Entra ID & Microsoft 365', icon: <Cloud size={16} /> },
  { path: '/discovery/entra-id-app', label: 'Entra ID Application', icon: <AppWindow size={16} /> },
  ...
  // =========================================================================
  { path: '/discovery/applications', label: 'Application', icon: <Package size={16} /> },
  { path: '/discovery/aws', label: 'AWS Cloud Infrastructure', icon: <Cloud size={16} /> },
  ...
  { path: '/discovery/certificate', label: 'Certificate', icon: <Key size={16} /> },
  ...
  { path: '/discovery/environment', label: 'Environment Detection', icon: <Radar size={16} /> },
  { path: '/discovery/external-identity', label: 'External Identity', icon: <Users size={16} /> },
  ...
  { path: '/discovery/gcp', label: 'GCP Cloud Infrastructure', icon: <Cloud size={16} /> },
  ...
  { path: '/discovery/panorama-interrogation', label: 'Panorama Interrogation', icon: <Shield size={16} /> },
  { path: '/discovery/physical-server', label: 'Physical Server', icon: <Server size={16} /> },
  { path: '/discovery/printer', label: 'Printer', icon: <Printer size={16} /> },
  { path: '/discovery/scheduled-task', label: 'Scheduled Task', icon: <Calendar size={16} /> },
  ...
  { path: '/discovery/web-server', label: 'Web Server Configuration', icon: <Globe size={16} /> },
];
