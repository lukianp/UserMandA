    ...
    <div className="h-full flex flex-col" data-cy="execution-view">
      ...
      <div className="p-4 bg-gray-50 border-b">
        ...
        <div className="grid grid-cols-5 gap-4">
          <div className="bg-white p-3 rounded shadow-sm"><div className="text-2xl font-bold">{logic.stats.total}</div><div className="text-xs">Total</div></div>
          <div className="bg-white p-3 rounded shadow-sm"><div className="text-2xl font-bold text-green-600">{logic.stats.completed}</div><div className="text-xs">Completed</div></div>
          <div className="bg-white p-3 rounded shadow-sm"><div className="text-2xl font-bold text-red-600">{logic.stats.failed}</div><div className="text-xs">Failed</div></div>
          <div className="bg-white p-3 rounded shadow-sm"><div className="text-2xl font-bold text-blue-600">{logic.stats.inProgress}</div><div className="text-xs">In Progress</div></div>
          <div className="bg-white p-3 rounded shadow-sm"><div className="text-2xl font-bold text-gray-600">{logic.stats.pending}</div><div className="text-xs">Pending</div></div>
        </div>
      </div>
