    ...
    <div className="flex flex-col h-full p-6 space-y-6" data-cy="a-p-i-management-view">
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          Manage API integrations and connections
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
        ...
        <h2 className="text-xl font-semibold mb-2">API Management Module</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          This advanced feature provides comprehensive API management capabilities.
        </p>
