...
// Mock the hook
jest.mock('../../hooks/useServiceCatalogLogic', () => ({
  useServiceCatalogLogic: jest.fn(),
}));

const { useServiceCatalogLogic } = require('../../hooks/useServiceCatalogLogic');

describe('ServiceCatalogView', () => {
