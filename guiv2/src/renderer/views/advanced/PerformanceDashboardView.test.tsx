/**
 * Unit Tests for PerformanceDashboardView
 */
...
describe.skip('PerformanceDashboardView', () => {
  ...
  beforeEach(() => {
    resetAllMocks();
    usePerformanceDashboardLogic.mockReturnValue(mockHookDefaults);
  });
  ...
  describe.skip('Rendering', () => {
    ...
    it('displays the view description', () => {
      render(<PerformanceDashboardView />);
      expect(
        screen.getByText(/View performance metrics/i)
      ).toBeInTheDocument();
    });

    it('displays the icon', () => {
      const { container } = render(<PerformanceDashboardView />);
  ...
  describe.skip('Integration', () => {
    it('handles complete workflow', async () => {
      ...
      const { rerender } = render(<PerformanceDashboardView />);
      const hasLoadingIndicator = screen.queryAllByRole('status').length > 0 || screen.queryByText(/loading/i) !== null;
      expect(hasLoadingIndicator).toBe(true);
      ...
      rerender(<PerformanceDashboardView />);
      expect(screen.queryByRole('status')).not.toBeInTheDocument();
