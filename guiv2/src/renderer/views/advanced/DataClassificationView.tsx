...
export const DataClassificationView: React.FC = () => {
  return (
    <div className="flex flex-col h-full p-6 space-y-6" data-testid="data-classification-view" data-cy="data-classification-view">
      <div>
        <h1 className="text-2xl font-bold">Data Classification</h1>
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          Manage Data Classification settings and policies
        </p>
      </div>
