...
// Import autogenerated routes from generator script
import { AUTO_DISCOVERY_ROUTES, AUTO_MIGRATION_ROUTES } from './AppRoutes.autogen';
    ...
    <MainLayout>
            <Suspense fallback={<LoadingFallback />}>
              ...
              <Route path="/discovery">
                ...
                {/* Auto-generated discovery routes from all PowerShell modules */}
                {AUTO_DISCOVERY_ROUTES.map((route) => (
                  <Route key={route.path} path={route.path.replace('/discovery/', '')} element={route.element} />
                ))}

                {/* Legacy manual routes - kept for backwards compatibility */}
                ...
                <Route path="conditional-access-policies" element={<ConditionalAccessPoliciesDiscoveryView />} />
                <Route path="data-loss-prevention" element={<DataLossPreventionDiscoveryView />} />
                <Route path="web-server-configuration" element={<WebServerConfigurationDiscoveryView />} />
                <Route path="hyperv" element={<HyperVDiscoveryView />} />
                <Route path="environment-detection-view" element={<EnvironmentDetectionView />} />
              </Route>
              ...
              <Route path="/migration">
                ...
                {/* Auto-generated migration routes from all PowerShell modules */}
                {AUTO_MIGRATION_ROUTES.map((route) => (
                  <Route key={route.path} path={route.path.replace('/migration/', '')} element={route.element} />
                ))}
              </Route>
