...
/* harmony export */   p: () => (/* binding */ useMigrationValidationLogic)
/* harmony export */ });
...
const useMigrationValidationLogic = () => {
    const { selectedWave, validationResults, isLoading, error, validateWave, validateAll, clearValidationResults, } = (0,_store_useMigrationStore__WEBPACK_IMPORTED_MODULE_1__/* .useMigrationStore */ .V)();
