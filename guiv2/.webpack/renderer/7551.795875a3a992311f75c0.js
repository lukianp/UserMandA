...
const useInfrastructureLogic = () => {
    const { addResult } = (0,useDiscoveryStore/* useDiscoveryStore */.R)();
...
const InfrastructureView = () => {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "h-full flex flex-col bg-gray-50 dark:bg-gray-900", "data-cy": "infrastructure-view", "data-testid": "infrastructure-view", children: [(0,jsx_runtime.jsx)("div", { className: "bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4", children: (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [(0,jsx_runtime.jsx)(lucide_react/* Server */.gq4, { className: "w-8 h-8 text-purple-600 dark:text-purple-400" }), (0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: "Infrastructure" }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: "Network infrastructure and server inventory" })] })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [(0,jsx_runtime.jsx)(Button/* Button */.$, { variant: "secondary", onClick: loadInfrastructure, loading: isLoading, icon: (0,jsx_runtime.jsx)(lucide_react/* RefreshCw */.e9t, { className: "w-4 h-4" }), "data-cy": "refresh-btn", "data-testid": "refresh-btn", children: "Refresh" }), (0,jsx_runtime.jsx)(Button/* Button */.$, { variant: "primary", onClick: handleExport, disabled: infrastructure.length === 0, icon: (0,jsx_runtime.jsx)(lucide_react/* Download */.f5X, { className: "w-4 h-4" }), "data-cy": "export-btn", "data-testid": "export-btn", children: "Export" })] })] }) }), (0,jsx_runtime.jsx)("div", { className: "bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-3", children: (0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-4", children: [(0,jsx_runtime.jsx)("div", { className: "flex-1", children: (0,jsx_runtime.jsx)(SearchBar/* default */.A, { value: searchText, onChange: setSearchText, placeholder: "Search by name or IP address...", "data-cy": "infrastructure-search", "data-testid": "infrastructure-search" }) }), (0,jsx_runtime.jsx)("div", { className: "w-48", children: (0,jsx_runtime.jsx)(Select/* Select */.l, { value: filterType, onChange: (value) => setFilterType(value), options: [
                                    { value: 'all', label: 'All Types' },
                                    { value: 'server', label: 'Servers' },
                                    { value: 'network', label: 'Network Devices' },
                                    { value: 'storage', label: 'Storage' },
                                    { value: 'virtualization', label: 'Virtualization' },
                                ], "data-cy": "type-filter", "data-testid": "type-filter" }) })] }) }), (0,jsx_runtime.jsx)("div", { className: "flex-1 p-6", children: (0,jsx_runtime.jsx)("div", { className: "h-full bg-white dark:bg-gray-800 rounded-lg shadow-md p-4", children: (0,jsx_runtime.jsx)(VirtualizedDataGrid/* VirtualizedDataGrid */.Q, { data: infrastructure, columns: columnDefs, loading: isLoading, onSelectionChange: setSelectedItems, enableExport: true, "data-cy": "infrastructure-grid", "data-testid": "infrastructure-grid" }) }) }), (0,jsx_runtime.jsx)("div", { className: "bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-6 py-2", children: (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between text-sm text-gray-600 dark:text-gray-400", children: [(0,jsx_runtime.jsxs)("span", { children: ["Total items: ", infrastructure.length] }), (0,jsx_runtime.jsxs)("span", { children: ["Selected: ", (selectedItems?.length ?? 0)] })] }) })] }));
};
