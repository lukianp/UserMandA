...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   R: () => (/* binding */ useAzureDiscoveryLogic)
/* harmony export */ });
...
const useAzureDiscoveryLogic = () => {
    ...
    const { addResult, setProgress, getResultsByModuleName } = (0,_store_useDiscoveryStore__WEBPACK_IMPORTED_MODULE_2__/* .useDiscoveryStore */ .R)();
    // Form state
    ...
    const exportResults = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
        if (results.length === 0)
            return;
        const api = (0,_lib_electron_api_fallback__WEBPACK_IMPORTED_MODULE_3__/* .getElectronAPI */ .d)();
