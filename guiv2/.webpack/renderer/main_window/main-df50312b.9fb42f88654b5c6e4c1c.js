"use strict";
(global["webpackChunkguiv2"] = global["webpackChunkguiv2"] || []).push([[1980],{
...
const NotificationContainer = () => {
    const notifications = (0,useNotificationStore/* useNotificationStore */.i)((state) => state.toasts);
    const dismissToast = (0,useNotificationStore/* useNotificationStore */.i)((state) => state.dismissToast);
    ...
    const getIcon = (type) => {
        switch (type) {
            case 'success':
                return (0,jsx_runtime.jsx)(lucide_react/* CheckCircle */.rAV, { className: "w-5 h-5 text-green-500" });
            case 'error':
                return (0,jsx_runtime.jsx)(lucide_react/* XCircle */.Jpz, { className: "w-5 h-5 text-red-500" });
            case 'warning':
                return (0,jsx_runtime.jsx)(lucide_react/* AlertTriangle */.hcu, { className: "w-5 h-5 text-yellow-500" });
            case 'info':
                return (0,jsx_runtime.jsx)(lucide_react/* Info */.R2D, { className: "w-5 h-5 text-blue-500" });
            default:
                return (0,jsx_runtime.jsx)(lucide_react/* Info */.R2D, { className: "w-5 h-5 text-gray-500" });
        }
    };
...
const SystemStatus = ({ indicators, showLastSync = true, className = '', 'data-cy': dataCy, }) => {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: `space-y-2 ${className}`, "data-cy": dataCy || 'system-status', children: [(0,jsx_runtime.jsx)("h3", { className: "text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-3", children: "System Status" }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", "data-cy": "status-logic-engine", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react/* Database */.WmV, { className: "w-3 h-3 text-gray-400 dark:text-gray-500", "aria-hidden": "true" }), (0,jsx_runtime.jsx)("span", { className: "text-xs text-gray-600 dark:text-gray-400", children: "Logic Engine" })] }), (0,jsx_runtime.jsx)(StatusIndicator/* StatusIndicator */.k, { status: getStatusType(indicators.logicEngine), text: indicators.logicEngine, size: "sm", animate: indicators.logicEngine === 'degraded' })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", "data-cy": "status-powershell", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react/* Server */.gq4, { className: "w-3 h-3 text-gray-400 dark:text-gray-500", "aria-hidden": "true" }), (0,jsx_runtime.jsx)("span", { className: "text-xs text-gray-600 dark:text-gray-400", children: "PowerShell" })] }), (0,jsx_runtime.jsx)(StatusIndicator/* StatusIndicator */.k, { status: getStatusType(indicators.powerShell), text: indicators.powerShell, size: "sm", animate: indicators.powerShell === 'degraded' })] }), (0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", "data-cy": "status-data-connection", children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react/* Shield */.ekZ, { className: "w-3 h-3 text-gray-400 dark:text-gray-500", "aria-hidden": "true" }), (0,jsx_runtime.jsx)("span", { className: "text-xs text-gray-600 dark:text-gray-400", children: "Data Connection" })] }), (0,jsx_runtime.jsx)(StatusIndicator/* StatusIndicator */.k, { status: getStatusType(indicators.dataConnection), text: indicators.dataConnection, size: "sm", animate: indicators.dataConnection === 'degraded' })] }), showLastSync && ((0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2 pt-2 border-t border-gray-200 dark:border-gray-700", "data-cy": "status-last-sync", children: [(0,jsx_runtime.jsx)(lucide_react/* Activity */.Ilq, { className: "w-3 h-3 text-gray-400 dark:text-gray-500", "aria-hidden": "true" }), (0,jsx_runtime.jsxs)("span", { className: "text-xs text-gray-500 dark:text-gray-400", children: ["Sync: ", formatLastSync(indicators.lastSync)] })] }))] }));
};
...
const ProfileSelector = ({ type, label, showActions = true, onCreateProfile, className, 'data-cy': dataCy, }) => {
    const { sourceProfiles, targetProfiles, selectedSourceProfile, selectedTargetProfile, connectionStatus, isLoading, error, setSelectedSourceProfile, setSelectedTargetProfile, deleteSourceProfile, testConnection, loadSourceProfiles, } = (0,useProfileStore/* useProfileStore */.K)();
    ...
    const handleCreateProfile = () => {
        if (onCreateProfile) {
            ...
            const { openModal } = useModalStore/* useModalStore */.K.getState();
            openModal({
                type: 'createProfile',
    ...
    const getConnectionLabel = () => {
        if (isTesting)
            return 'Testing...';
        const { consecutiveHeartbeatFailures } = useProfileStore/* useProfileStore */.K.getState();
        switch (connectionStatus) {
            case 'connected':
                return 'Online';
            case 'connecting':
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: (0,clsx/* clsx */.$)('flex flex-col gap-3', className), "data-cy": dataCy, children: [(0,jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [label && (0,jsx_runtime.jsx)("span", { className: "text-xs font-semibold text-gray-400 uppercase tracking-wide", children: label }), selectedProfile && ((0,jsx_runtime.jsx)(StatusIndicator/* StatusIndicator */.k, { status: getConnectionStatus(), text: getConnectionLabel(), size: "sm", animate: isTesting || connectionStatus === 'connecting' }))] }), (0,jsx_runtime.jsx)(Select/* Select */.l, { value: selectedProfile?.id || '', onChange: handleProfileChange, options: profiles.map(profile => {
...
const useSystemHealthLogic = () => {
    ...
    const profileConnectionStatus = (0,useProfileStore/* useProfileStore */.K)((state) => state.connectionStatus);
    /**
...
// EXTERNAL MODULE: ./src/renderer/views/discovered/_sidebar.generated.tsx
var _sidebar_generated = __webpack_require__(71716);
 ...
 */
const Sidebar = () => {
    const { selectedSourceProfile, selectedTargetProfile } = (0,useProfileStore/* useProfileStore */.K)();
    const { systemStatus } = useSystemHealthLogic();
    ...
    const discoveredItems = (0,react.useMemo)(() => _sidebar_generated/* discoveredNavItems */.a, []);
    // Setup menu items (admin-only)
    const setupItems = [
        {
            path: '/setup/company',
            label: 'Company',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Building2 */.t6i, { size: 16 }),
        },
        {
            path: '/setup/azure-prerequisites',
            label: 'Azure Prerequisites',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Cloud */.Esr, { size: 16 }),
        },
        {
            path: '/setup/installers',
            label: 'Installers',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Download */.f5X, { size: 16 }),
        },
    ];
    // Navigation items
    const navItems = [
        {
            path: '/',
            label: 'Overview',
            icon: (0,jsx_runtime.jsx)(lucide_react/* LayoutDashboard */.HxJ, { size: 20 }),
        },
        {
            path: '/setup',
            label: 'Setup',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Wrench */.IFY, { size: 20 }),
            children: setupItems,
        },
        {
            path: '/discovery',
            label: 'Discovery',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Search */.vji, { size: 20 }),
            children: [
                {
                    path: '/discovered',
                    label: 'Discovered',
                    icon: (0,jsx_runtime.jsx)(lucide_react/* FileSearch */.Xq3, { size: 18 }),
        ...
        },
        {
            path: '/users',
            label: 'Users',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Users */.zWC, { size: 20 }),
        },
        {
            path: '/groups',
            label: 'Groups',
            icon: (0,jsx_runtime.jsx)(lucide_react/* UserCheck */.MWd, { size: 20 }),
        },
        {
            path: '/infrastructure',
            label: 'Infrastructure',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Server */.gq4, { size: 20 }),
        },
        {
            path: '/organisation-map',
            label: 'Organisation Map',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Workflow */.WuS, { size: 20 }),
        },
        {
            path: '/migration',
            label: 'Migration',
            icon: (0,jsx_runtime.jsx)(lucide_react/* ArrowRightLeft */.nFs, { size: 20 }),
            children: [
                { path: '/migration/planning', label: 'Planning', icon: (0,jsx_runtime.jsx)(lucide_react/* ChevronRight */.c_$, { size: 16 }) },
                { path: '/migration/mapping', label: 'Mapping', icon: (0,jsx_runtime.jsx)(lucide_react/* ChevronRight */.c_$, { size: 16 }) },
                { path: '/migration/validation', label: 'Validation', icon: (0,jsx_runtime.jsx)(lucide_react/* ChevronRight */.c_$, { size: 16 }) },
                { path: '/migration/execution', label: 'Execution', icon: (0,jsx_runtime.jsx)(lucide_react/* ChevronRight */.c_$, { size: 16 }) },
            ],
        },
        {
            path: '/reports',
            label: 'Reports',
            icon: (0,jsx_runtime.jsx)(lucide_react/* FileText */.iUU, { size: 20 }),
        },
        {
            path: '/settings',
            label: 'Settings',
            icon: (0,jsx_runtime.jsx)(lucide_react/* Settings */.wB_, { size: 20 }),
        },
    ];
 ...
 */
const TabView = () => {
    const { tabs, selectedTabId, setSelectedTab, closeTab } = (0,useTabStore/* useTabStore */.W)();
    if (tabs.length === 0) {
        return null;
    }
...
const createCommandRegistry = (navigate, openModal, triggerAction) => {
    return [
        ...
        },
        {
            ...
            category: 'Navigation',
            icon: lucide_react/* Calendar */.VvS,
        ...
        },
        {
            ...
            category: 'Navigation',
            icon: lucide_react/* FileText */.iUU,
        ...
        },
        {
            ...
            category: 'Navigation',
            icon: lucide_react/* Settings */.wB_,
            shortcut: 'Ctrl+,',
        ...
        },
        {
            ...
            category: 'Actions',
            icon: lucide_react/* Download */.f5X,
            shortcut: 'Ctrl+E',
        ...
        },
        {
            ...
            category: 'Actions',
            icon: lucide_react/* RefreshCw */.e9t,
            shortcut: 'F5',
...
const CommandPalette = () => {
    ...
    const { closeCommandPalette, openModal } = (0,useModalStore/* useModalStore */.K)();
...
const MainLayout = ({ children }) => {
    const { isCommandPaletteOpen } = (0,useModalStore/* useModalStore */.K)();
...
const ThemeInitializer = () => {
    const { mode, actualMode } = (0,useThemeStore/* useThemeStore */.C)();
    (0,react.useEffect)(() => {
 ...
 */
const AppContent = () => {
    const routing = (0,dist.useRoutes)(routes/* default */.A);
...
const App = () => {
    ...
    return ((0,jsx_runtime.jsxs)(ErrorBoundary, { onError: handleError, showDetails: true, children: [(0,jsx_runtime.jsx)(ThemeInitializer, {}), (0,jsx_runtime.jsx)(NotificationContainer, {}), (0,jsx_runtime.jsx)(ModalContainer, {}), (0,jsx_runtime.jsx)(react_dnd_dist/* DndProvider */.QP, { backend: react_dnd_html5_backend_dist/* HTML5Backend */.t2, children: (0,jsx_runtime.jsx)(dist.HashRouter, { children: (0,jsx_runtime.jsx)(AppContent, {}) }) })] }));
};
...
/* harmony export */   k: () => (/* binding */ StatusIndicator)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74848);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96540);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34164);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   y: () => (/* binding */ Spinner)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74848);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(96540);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34164);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   d: () => (/* binding */ getElectronAPI)
/* harmony export */ });
/* unused harmony export electronAPIFallback */
/* provided dependency */ var process = __webpack_require__(33834);
/**
...
const Button = (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(({ variant = 'primary', size = 'md', icon, iconPosition = 'leading', loading = false, disabled = false, fullWidth = false, children, className, onClick, 'data-cy': dataCy, ...props }, ref) => {
    ...
    const renderLoadingIcon = () => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_3__/* .Loader2 */ .krw, { className: "animate-spin", size: 16, "aria-hidden": "true" }));
    // Render icon
    const renderIcon = () => {
        if (loading)
