...
/***/ 92979:
/*!***************************************************************!*\
  !*** ./src/renderer/views/admin/AuditLogView.tsx + 1 modules ***!
  \***************************************************************/
...
const useAuditLogLogic = () => {
    ...
    const handleExport = async () => {
        try {
            ...
            await exportService["default"].exportToExcel(filteredLogs, 'AuditLogs');
...
const AuditLogView = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 150,
            cellRenderer: (params) => ((0,jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react.User, { className: "w-4 h-4 text-gray-500" }), (0,jsx_runtime.jsx)("span", { children: params.value })] })),
        },
        {
            field: 'action',
            headerName: 'Action',
        ...
        },
        {
            ...
            filter: 'agSetColumnFilter',
            width: 140,
            cellRenderer: (params) => ((0,jsx_runtime.jsx)(Badge.Badge, { variant: "info", children: params.value })),
        },
        {
            field: 'severity',
            headerName: 'Severity',
            ...
            filter: 'agSetColumnFilter',
            width: 120,
            cellRenderer: (params) => ((0,jsx_runtime.jsx)(Badge.Badge, { variant: params.value === 'Critical' ? 'danger' :
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "flex flex-col h-full p-6 space-y-6", "data-testid": "audit-log-view", "data-cy": "audit-log-view", children: [(0,jsx_runtime.jsxs)("div", { className: "flex justify-between items-center", children: [(0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: "Audit Log" }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-600 dark:text-gray-400 mt-1", children: "Track all user actions and system events for compliance and security" })] }), (0,jsx_runtime.jsxs)("div", { className: "flex gap-2", children: [(0,jsx_runtime.jsx)(Button.Button, { variant: "secondary", icon: (0,jsx_runtime.jsx)(lucide_react.Activity, { className: "h-4 w-4" }), onClick: handleRefresh, children: "Refresh" }), (0,jsx_runtime.jsx)(Button.Button, { variant: "primary", icon: (0,jsx_runtime.jsx)(lucide_react.Download, { className: "h-4 w-4" }), onClick: handleExport, children: "Export Logs" })] })] }), (0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-5 gap-4", children: [(0,jsx_runtime.jsx)("div", { className: "col-span-2", children: (0,jsx_runtime.jsx)(Input.Input, { label: "Search", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), placeholder: "Search by user, action, or details..." }) }), (0,jsx_runtime.jsx)("div", { children: (0,jsx_runtime.jsx)(Select.Select, { label: "Action", value: actionFilter, onChange: (value) => setActionFilter(value), options: [
                            ...
                            ] }) }), (0,jsx_runtime.jsx)("div", { children: (0,jsx_runtime.jsx)(Select.Select, { label: "Severity", value: severityFilter, onChange: (value) => setSeverityFilter(value), options: [
                                { value: '', label: 'All Severities' },
                                { value: 'Critical', label: 'Critical' },
                                { value: 'Warning', label: 'Warning' },
                                { value: 'Info', label: 'Info' },
                                { value: 'Success', label: 'Success' },
                            ] }) }), (0,jsx_runtime.jsx)("div", { children: (0,jsx_runtime.jsx)(Select.Select, { label: "Time Range", value: dateRange, onChange: (value) => setDateRange(value), options: [
                                { value: 'today', label: 'Today' },
                                { value: 'week', label: 'Last 7 Days' },
                                { value: 'month', label: 'Last 30 Days' },
                                { value: 'quarter', label: 'Last 90 Days' },
                                { value: 'all', label: 'All Time' },
                            ] }) })] }), (0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-5 gap-4", children: [(0,jsx_runtime.jsxs)("div", { className: "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800", children: [(0,jsx_runtime.jsx)("div", { className: "text-sm text-blue-600 dark:text-blue-400", children: "Total Events" }), (0,jsx_runtime.jsx)("div", { className: "text-2xl font-bold text-blue-900 dark:text-blue-100", children: (auditLogs ?? []).length })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800", children: [(0,jsx_runtime.jsx)("div", { className: "text-sm text-red-600 dark:text-red-400", children: "Critical" }), (0,jsx_runtime.jsx)("div", { className: "text-2xl font-bold text-red-900 dark:text-red-100", children: (auditLogs ?? []).filter(log => log.severity === 'Critical').length })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800", children: [(0,jsx_runtime.jsx)("div", { className: "text-sm text-yellow-600 dark:text-yellow-400", children: "Warnings" }), (0,jsx_runtime.jsx)("div", { className: "text-2xl font-bold text-yellow-900 dark:text-yellow-100", children: (auditLogs ?? []).filter(log => log.severity === 'Warning').length })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800", children: [(0,jsx_runtime.jsx)("div", { className: "text-sm text-green-600 dark:text-green-400", children: "Success" }), (0,jsx_runtime.jsx)("div", { className: "text-2xl font-bold text-green-900 dark:text-green-100", children: (auditLogs ?? []).filter(log => log.success).length })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-gray-50 dark:bg-gray-900/20 p-4 rounded-lg border border-gray-200 dark:border-gray-800", children: [(0,jsx_runtime.jsx)("div", { className: "text-sm text-gray-600 dark:text-gray-400", children: "Failed" }), (0,jsx_runtime.jsx)("div", { className: "text-2xl font-bold text-gray-900 dark:text-gray-100", children: (auditLogs ?? []).filter(log => !log.success).length })] })] }), (0,jsx_runtime.jsx)("div", { className: "flex-1", children: (0,jsx_runtime.jsx)(VirtualizedDataGrid.VirtualizedDataGrid, { data: auditLogs, columns: columns, loading: isLoading }) })] }));
};
