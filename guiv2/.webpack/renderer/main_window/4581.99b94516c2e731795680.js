...
/***/ 34581:
/*!***********************************************************************!*\
  !*** ./src/renderer/views/analytics/CostAnalysisView.tsx + 1 modules ***!
  \***********************************************************************/
...
const CostAnalysisView = () => {
    ...
    const costMetrics = [
        { label: 'Monthly Cost', value: `$${(costData?.totalMonthlyCost || 0).toLocaleString()}`, icon: lucide_react.DollarSign, color: 'blue' },
        { label: 'Annual Cost', value: `$${(costData?.totalAnnualCost || 0).toLocaleString()}`, icon: lucide_react.BarChart3, color: 'purple' },
        { label: 'Optimizations', value: (costData?.optimizations?.length || 0).toString(), icon: lucide_react.PieChart, color: 'green' },
        { label: 'Potential Savings', value: `$${(potentialSavings ?? 0).toLocaleString()}`, icon: lucide_react.Calculator, color: 'orange' },
    ];
    const timeRanges = [
