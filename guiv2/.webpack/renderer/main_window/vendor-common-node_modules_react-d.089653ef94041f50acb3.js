"use strict";
(global["webpackChunkguiv2"] = global["webpackChunkguiv2"] || []).push([[3587],{
...
{} else {
  module.exports = __webpack_require__(/*! ./cjs/react-is.development.js */ 98413);
}
...
/***/ 64074:
/*!***********************************************************!*\
  !*** ./node_modules/react-dnd/dist/index.js + 44 modules ***!
  \***********************************************************/
...
function createSingletonDndContext(backend, context = getGlobalContext(), options, debugMode) {
    ...
    if (!ctx[INSTANCE_SYM]) {
        ctx[INSTANCE_SYM] = {
            dragDropManager: (0,dist.createDragDropManager)(backend, context, options, debugMode)
        };
    }
...
class DragSourceMonitorImpl {
    ...
    canDrag() {
        (0,invariant_dist.invariant)(!isCallingCanDrag, 'You may not call monitor.canDrag() inside your canDrag() implementation. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drag-source-monitor');
        try {
    ...
    isDragging() {
        ...
        (0,invariant_dist.invariant)(!isCallingIsDragging, 'You may not call monitor.isDragging() inside your isDragging() implementation. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drag-source-monitor');
        try {
...
class DropTargetMonitorImpl {
    ...
    canDrop() {
        ...
        (0,invariant_dist.invariant)(!isCallingCanDrop, 'You may not call monitor.canDrop() inside your canDrop() implementation. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target-monitor');
        try {
...
function cloneWithRef(element, newRef) {
    ...
    (0,invariant_dist.invariant)(typeof previousRef !== 'string', 'Cannot connect React DnD to an element with an existing string ref. ' + 'Please convert it to use a callback ref instead, or wrap it into a <span> or <div>. ' + 'Read more: https://reactjs.org/docs/refs-and-the-dom.html#callback-refs');
    if (!previousRef) {
 ...
 */ function useDragDropManager_useDragDropManager() {
    ...
    (0,invariant_dist.invariant)(dragDropManager != null, 'Expected drag drop context');
...
function useDragType(spec) {
    return (0,react.useMemo)(()=>{
        ...
        (0,invariant_dist.invariant)(result != null, 'spec.type must be defined');
        return result;
    }, [
        spec
    ]);
 ...
 */ function useDrag(specArg, deps) {
    ...
    (0,invariant_dist.invariant)(!spec.begin, `useDrag::spec.begin was deprecated in v14. Replace spec.begin() with spec.item(). (see more here - https://react-dnd.github.io/react-dnd/docs/api/use-drag)`);
 ...
 */ function useAccept(spec) {
    const { accept  } = spec;
    return (0,react.useMemo)(()=>{
        (0,invariant_dist.invariant)(spec.accept != null, 'accept must be defined');
...
/***/ 72706:
/*!****************************************************************!*\
  !*** ./node_modules/@react-dnd/asap/dist/index.js + 6 modules ***!
  \****************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* provided dependency */ var process = __webpack_require__(/*! process/browser */ 7293);
/**
