...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var xlsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! xlsx */ 3959);
/* harmony import */ var jspdf__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jspdf */ 13596);
/**
...
class ExportService {
    ...
    async exportToExcel(data, filename, options = {}) {
        ...
        if (options.sheets && options.sheets.length > 0) {
            ...
            for (const sheet of options.sheets) {
                ...
                xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.book_append_sheet(workbook, ws, sheet.name);
            }
        }
        else {
            // Single sheet
    ...
    createWorksheet(data, options) {
        ...
        const ws = xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.json_to_sheet(filtered, {
    ...
    async exportToPDF(data, filename, options = {}) {
        ...
        const doc = new jspdf__WEBPACK_IMPORTED_MODULE_1__["default"]({ orientation, unit: 'pt' });
        // Add title
        if (options.title) {
            doc.setFontSize(16);
