"use strict";
(global["webpackChunkguiv2"] = global["webpackChunkguiv2"] || []).push([[3655],{

/***/ 16072:
/*!********************************************************************************!*\
  !*** ./node_modules/@floating-ui/react/dist/floating-ui.react.mjs + 2 modules ***!
  \********************************************************************************/
...
__webpack_require__.d(__webpack_exports__, {
  autoUpdate: () => (/* reexport */ floating_ui_dom.autoUpdate),
  flip: () => (/* reexport */ flip),
  inner: () => (/* binding */ inner),
  offset: () => (/* reexport */ offset),
  shift: () => (/* reexport */ shift),
  size: () => (/* reexport */ size),
  useFloating: () => (/* binding */ floating_ui_react_useFloating),
...
function useFloating(options) {
  ...
  const update = react.useCallback(() => {
    ...
    (0,floating_ui_dom.computePosition)(referenceRef.current, floatingRef.current, config).then(data => {
      const fullData = {
        ...data,
...
const offset = (options, deps) => ({
  ...(0,floating_ui_dom.offset)(options),
...
const shift = (options, deps) => ({
  ...(0,floating_ui_dom.shift)(options),
  options: [options, deps]
});
...
const flip = (options, deps) => ({
  ...(0,floating_ui_dom.flip)(options),
  options: [options, deps]
});
...
const size = (options, deps) => ({
  ...(0,floating_ui_dom.size)(options),
  options: [options, deps]
});
...
function useFloatingRootContext(options) {
  ...
  if (true) {
    ...
    if (optionDomReference && !(0,floating_ui_utils_dom.isElement)(optionDomReference)) {
...
function floating_ui_react_useFloating(options) {
  ...
  const setPositionReference = react.useCallback(node => {
    const computedPositionReference = (0,floating_ui_utils_dom.isElement)(node) ? {
  ...
  const setReference = react.useCallback(node => {
    if ((0,floating_ui_utils_dom.isElement)(node) || node === null) {
    ...
    if ((0,floating_ui_utils_dom.isElement)(position.refs.reference.current) || position.refs.reference.current === null ||
    // Don't allow setting virtual elements using the old technique back to
    // `null` to support `positionReference` + an unstable `reference`
    // callback ref.
    node !== null && !(0,floating_ui_utils_dom.isElement)(node)) {
...
const inner = props => ({
  ...
  async fn(state) {
    ...
    } = (0,floating_ui_utils.evaluate)(props, state);
    const {
      rects,
      elements: {
        floating
    ...
    const overflow = await (0,floating_ui_dom.detectOverflow)(getArgsWithCustomFloatingHeight(nextArgs, scrollEl.scrollHeight + clientTop + floating.clientTop), detectOverflowOptions);
    const refOverflow = await (0,floating_ui_dom.detectOverflow)(nextArgs, {
      ...detectOverflowOptions,
      elementContext: 'reference'
    });
    const diffY = (0,floating_ui_utils.max)(0, overflow.top);
    const nextY = nextArgs.y + diffY;
    const isScrollable = scrollEl.scrollHeight > scrollEl.clientHeight;
    const rounder = isScrollable ? v => v : floating_ui_utils.round;
    const maxHeight = rounder((0,floating_ui_utils.max)(0, scrollEl.scrollHeight + (floatingIsBordered && floatingIsScrollEl || scrollElIsBordered ? clientTop * 2 : 0) - diffY - (0,floating_ui_utils.max)(0, overflow.bottom)));
    scrollEl.style.maxHeight = maxHeight + "px";
    scrollEl.scrollTop = diffY;

    // There is not enough space, fallback to standard anchored positioning
    if (onFallbackChange) {
      const shouldFallback = scrollEl.offsetHeight < item.offsetHeight * (0,floating_ui_utils.min)(minItemsVisible, listRef.current.length) - 1 || refOverflow.top >= -referenceOverflowThreshold || refOverflow.bottom >= -referenceOverflowThreshold;
      react_dom.flushSync(() => onFallbackChange(shouldFallback));
    }
    if (overflowRef) {
      overflowRef.current = await (0,floating_ui_dom.detectOverflow)(getArgsWithCustomFloatingHeight({
        ...nextArgs,
        y: nextY
