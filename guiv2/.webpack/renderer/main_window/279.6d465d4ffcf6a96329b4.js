...
/***/ 20279:
/*!**************************************************************************!*\
  !*** ./src/renderer/views/admin/SystemConfigurationView.tsx + 1 modules ***!
  \**************************************************************************/
...
const SystemConfigurationView = () => {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "flex flex-col h-full p-6 space-y-6 overflow-y-auto", "data-testid": "system-configuration-view", "data-cy": "system-configuration-view", children: [(0,jsx_runtime.jsxs)("div", { className: "flex justify-between items-center", children: [(0,jsx_runtime.jsxs)("div", { children: [(0,jsx_runtime.jsx)("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: "System Configuration" }), (0,jsx_runtime.jsx)("p", { className: "text-sm text-gray-600 dark:text-gray-400 mt-1", children: "Configure global application settings and preferences" })] }), (0,jsx_runtime.jsxs)("div", { className: "flex gap-2", children: [(0,jsx_runtime.jsx)(Button.Button, { variant: "secondary", icon: (0,jsx_runtime.jsx)(lucide_react.RotateCcw, {}), onClick: handleReset, disabled: !hasChanges, children: "Reset" }), (0,jsx_runtime.jsx)(Button.Button, { variant: "primary", icon: (0,jsx_runtime.jsx)(lucide_react.Save, {}), onClick: handleSave, disabled: !hasChanges, children: "Save Changes" })] })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700", children: [(0,jsx_runtime.jsxs)("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react.Database, { className: "w-5 h-5" }), "Database Settings"] }), (0,jsx_runtime.jsxs)("div", { className: "space-y-4", children: [(0,jsx_runtime.jsx)(Input.Input, { label: "Connection String", value: (config?.database?.connectionString ?? ''), onChange: (value) => handleChange('database.connectionString', value), placeholder: "Data Source=..." }), (0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [(0,jsx_runtime.jsx)(Input.Input, { label: "Command Timeout (seconds)", type: "number", value: (config?.database?.commandTimeout ?? ''), onChange: (e) => handleChange('database.commandTimeout', parseInt(e.target.value)) }), (0,jsx_runtime.jsx)(Input.Input, { label: "Max Pool Size", type: "number", value: (config?.database?.maxPoolSize ?? ''), onChange: (e) => handleChange('database.maxPoolSize', parseInt(e.target.value)) })] }), (0,jsx_runtime.jsx)(Button.Button, { variant: "secondary", onClick: () => handleTestConnection('database'), children: "Test Connection" })] })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700", children: [(0,jsx_runtime.jsxs)("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react.Mail, { className: "w-5 h-5" }), "Email Settings"] }), (0,jsx_runtime.jsxs)("div", { className: "space-y-4", children: [(0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [(0,jsx_runtime.jsx)(Input.Input, { label: "SMTP Server", value: (config?.email?.smtpServer ?? ''), onChange: (value) => handleChange('email.smtpServer', value) }), (0,jsx_runtime.jsx)(Input.Input, { label: "SMTP Port", type: "number", value: (config?.email?.smtpPort ?? ''), onChange: (e) => handleChange('email.smtpPort', parseInt(e.target.value)) })] }), (0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [(0,jsx_runtime.jsx)(Input.Input, { label: "Username", value: (config?.email?.username ?? ''), onChange: (value) => handleChange('email.username', value) }), (0,jsx_runtime.jsx)(Input.Input, { label: "From Address", type: "email", value: (config?.email?.fromAddress ?? ''), onChange: (value) => handleChange('email.fromAddress', value) })] }), (0,jsx_runtime.jsx)(Checkbox.Checkbox, { label: "Enable SSL", checked: (config?.email?.enableSsl ?? ''), onChange: (checked) => handleChange('email.enableSsl', checked) })] })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700", children: [(0,jsx_runtime.jsxs)("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react.Shield, { className: "w-5 h-5" }), "Security Settings"] }), (0,jsx_runtime.jsxs)("div", { className: "space-y-4", children: [(0,jsx_runtime.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [(0,jsx_runtime.jsx)(Input.Input, { label: "Session Timeout (minutes)", type: "number", value: (config?.security?.sessionTimeout ?? ''), onChange: (e) => handleChange('security.sessionTimeout', parseInt(e.target.value)) }), (0,jsx_runtime.jsx)(Input.Input, { label: "Max Login Attempts", type: "number", value: (config?.security?.maxLoginAttempts ?? ''), onChange: (e) => handleChange('security.maxLoginAttempts', parseInt(e.target.value)) })] }), (0,jsx_runtime.jsx)(Checkbox.Checkbox, { label: "Require Strong Passwords", checked: (config?.security?.requireStrongPassword ?? ''), onChange: (checked) => handleChange('security.requireStrongPassword', checked) }), (0,jsx_runtime.jsx)(Checkbox.Checkbox, { label: "Enable Audit Logging", checked: (config?.security?.enableAuditLog ?? ''), onChange: (checked) => handleChange('security.enableAuditLog', checked) })] })] }), (0,jsx_runtime.jsxs)("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700", children: [(0,jsx_runtime.jsxs)("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2", children: [(0,jsx_runtime.jsx)(lucide_react.Globe, { className: "w-5 h-5" }), "Application Settings"] }), (0,jsx_runtime.jsxs)("div", { className: "space-y-4", children: [(0,jsx_runtime.jsx)(Select.Select, { label: "Default Theme", value: (config?.application?.defaultTheme ?? ''), onChange: (value) => handleChange('application.defaultTheme', value), options: [
                                    { value: "light", label: "Light" },
                                    { value: "dark", label: "Dark" },
                                    { value: "system", label: "System" },
                                ] }), (0,jsx_runtime.jsx)(Select.Select, { label: "Date Format", value: (config?.application?.dateFormat ?? ''), onChange: (value) => handleChange('application.dateFormat', value), options: [
                                    { value: "MM/DD/YYYY", label: "MM/DD/YYYY" },
                                    { value: "DD/MM/YYYY", label: "DD/MM/YYYY" },
                                    { value: "YYYY-MM-DD", label: "YYYY-MM-DD" },
                                ] }), (0,jsx_runtime.jsx)(Input.Input, { label: "Items Per Page", type: "number", value: (config?.application?.itemsPerPage ?? ''), onChange: (e) => handleChange('application.itemsPerPage', parseInt(e.target.value)) })] })] })] }));
};
