...
namespace MandADiscoverySuite.Tests.ViewModels
{
    public class ProjectManagementDashboardViewModelTests
    {
        private class FakeDataService : IDataService
        {
            ...
            public Task<MandADiscoverySuite.Services.ExportResult> ExportDataAsync(string profileName, ExportOptions exportOptions, CancellationToken cancellationToken = default) =>
                Task.FromResult(new MandADiscoverySuite.Services.ExportResult());
