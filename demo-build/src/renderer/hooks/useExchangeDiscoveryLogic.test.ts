        ...
        mailboxes: [
          {
            ...
            itemCount: 1000,
            issueWarningQuota: 1024 * 1024 * 1000,
            prohibitSendQuota: 1024 * 1024 * 1500,
            prohibitSendReceiveQuota: 1024 * 1024 * 2000,
            ...
            whenChanged: new Date("2023-01-01T10:00:00Z"),
            isInactive: false,
  ...
  describe('Mailbox Filtering', () => {
    const mockMailboxes: ExchangeMailbox[] = [
      ...
      },
      {
        ...
        emailAddresses: ['jane@contoso.com'],
